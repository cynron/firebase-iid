...
public final class zzj {
   ...
   private static SharePrefsHelper zzmjg;
   ...
   public static synchronized zzj zza(Context var0, Bundle var1) {
      ...
      if(zzmjg == null) {
         zzmjg = new SharePrefsHelper(var0);
         zzmjh = new zzl(var0);
      }

      appVersion = Integer.toString(FirebaseInstanceId.getVersionCode(var0));
      zzj var3;
   ...
   public final long getCreationTime() {
      return zzmjg.getCreateTime(this.zzhtj);
   }
   ...
   public static SharePrefsHelper zzbyl() {
      return zzmjg;
   }
   ...
   public final String getToken(String var1, String var2, Bundle var3) throws IOException {
      if(Looper.getMainLooper() == Looper.myLooper()) {
         ...
         if(var3.getString("ttl") == null && !"jwt".equals(var3.getString("type"))) {
            TokenWrapper var5;
            if((var5 = zzmjg.zzo(this.zzhtj, var1, var2)) != null && !var5.shouldRefresh(appVersion)) {
               return var5.token;
            }
         } else {
            var4 = false;
         ...
         if((var6 = this.zzb(var1, var2, var3)) != null && var4) {
            zzmjg.zza(this.zzhtj, var1, var2, var6, appVersion);
         }
