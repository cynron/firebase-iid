               ...
               if(var3.startsWith("|")) {
                  ...
                  if(var5.length > 4) {
                     if("SYNC".equals(var5[3])) {
                        FirebaseInstanceId.zzej(this.ctx);
                     } else if("RST".equals(var5[3])) {
                        Context var10000 = this.ctx;
                        zzj.zza(this.ctx, (Bundle)null);
   ...
   private final Intent zzb(Bundle var1, KeyPair var2) throws IOException {
      ...
      if(this.zzhub != 0L && var15 <= this.zzhub) {
         ...
         if(zzhto == null) {
            ...
            var1.putString("gmsv", Integer.toString(FirebaseInstanceId.getPkgVersionCode(this.ctx, zzdg(this.ctx))));
            var1.putString("osv", Integer.toString(VERSION.SDK_INT));
            var1.putString("app_ver", Integer.toString(FirebaseInstanceId.getVersionCode(this.ctx)));
            var1.putString("app_ver_name", FirebaseInstanceId.getVersionName(this.ctx));
            ...
            var1.putString("sig", calcSign(var2, new String[]{this.ctx.getPackageName(), var18}));
            ...
            if(var23) {
               ...
               synchronized(this) {
                  if(zzhtt == null) {
                     ...
                     IntentFilter var27;
                     (var27 = new IntentFilter("com.google.android.c2dm.intent.REGISTRATION")).addCategory(var25.ctx.getPackageName());
                     var25.ctx.registerReceiver(zzhtt, var27, "com.google.android.c2dm.permission.SEND", (Handler)null);
                  }
               }
