...
public final class zzk {
   ...
   private final SharePrefsHelper zzmji;


   zzk(SharePrefsHelper var1) {
      this.zzmji = var1;
   }
   ...
   final void zzpq(String var1) {
      Object var2 = zzaqm;
      synchronized(zzaqm) {
         String var4 = this.zzmji.prefs.getString("topic_operaion_queue", "");
         String var5 = ",";
         ...
         this.zzmji.prefs.edit().putString("topic_operaion_queue", var3).apply();
      }
   }
   ...
   final String zzbyn() {
      ...
      synchronized(zzaqm) {
         String var2;
         String[] var3;
         return (var2 = this.zzmji.prefs.getString("topic_operaion_queue", (String)null)) != null && (var3 = var2.split(",")).length > 1 && !TextUtils.isEmpty(var3[1])?var3[1]:null;
      }
   }
   ...
   final boolean zzpu(String var1) {
      ...
      synchronized(zzaqm) {
         String var3;
         String var10000 = var3 = this.zzmji.prefs.getString("topic_operaion_queue", "");
