...
public final class zzq {
   ...
   public static synchronized zzq zzbyp() {
      if(zzmjn == null) {
         zzmjn = new zzq();
      }
   ...
   private static PendingIntent zza(Context var0, int var1, String var2, Intent var3, int var4) {
      Intent var5;
      (var5 = new Intent(var0, FirebaseInstanceIdInternalReceiver.class)).setAction(var2);
